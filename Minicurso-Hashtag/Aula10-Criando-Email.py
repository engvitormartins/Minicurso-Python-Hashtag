...
# tabela_tratada = pd.DataFrame(data=)

outlook = win32.Dispatch('outlook.application')
mail = outlook.CreateItem(0)
mail.To = 'vitormartinshp@gmail.com'
mail.Subject = 'Relatório de Vendas por Loja'
# mail.Attachments.Add('c:\\Users\\T-Gamer\\OneDrive\\01_Github_engvitormartins\\MeusProjetos\\Minicurso-Python-Hashtag\\Minicurso-Hashtag\\Vendas.xlsx')
